...
import './ContentWrapperHeader.css';

class ContentWrapperHeader extends Component {
    render() {
        return (
            <div className="content-wrapper-header">
                <div className="content-wrapper-context">
                    ...
                    <div className="content-text">Grab yourself 10 free images from Adobe
                        Stock in a
                        30-day free trial plan and find perfect image, that will help
                        you with
                        your new project.
                    </div>
                ...
                <img className="content-wrapper-img"
                     src="https://assets.codepen.io/3364143/glass.png" alt=""/>
            </div>
        );
    }
}
